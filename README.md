...
#TODO change to Yazda instead of strava
This gem provides a wrapper around the Yazda API - [http://strava.github.io/api/](http://strava.github.io/api/)

## Install

gem install 'yazda-api'
